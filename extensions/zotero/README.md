...
Reads `zotero.sqlite` with the system `sqlite3` instead of loading the database into JavaScript, so it
stays fast on large libraries and works in [Tinycast](https://tinycast.dev) as well as Raycast.
